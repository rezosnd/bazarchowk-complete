...
export default function ShopReviewsScreen() {
  ...
  const submitReview = async () => {
    ...
    try {
      ...
      Alert.alert('Success', 'Thank you for your shop review!');
      setComment('');
      fetchReviews();
    } catch (e: any) {
      const msg = e.response?.data?.message || 'Failed to submit review. Ensure you have received an order from this shop first.';
