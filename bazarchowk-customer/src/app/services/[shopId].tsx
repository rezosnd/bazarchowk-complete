...
const styles = StyleSheet.create({
  ...
  header: { paddingTop: 48, paddingBottom: 16, paddingHorizontal: 16, backgroundColor: '#FFF', flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#EAF8F0' },
  backBtn: { marginRight: 16 },
  headerTitle: { fontSize: 20, fontWeight: 'bold', color: '#122018' },
  
  stepTitle: { fontSize: 18, fontWeight: 'bold', color: '#122018', marginBottom: 12 },
  sectionContainer: { marginBottom: 24, gap: 12 },
  
  serviceCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16, backgroundColor: '#FFF', borderRadius: 12, borderWidth: 1, borderColor: '#E5EBE7' },
  serviceCardSelected: { borderColor: PRIMARY, backgroundColor: '#F0FDF4' },
  serviceName: { fontSize: 16, fontWeight: 'bold', color: '#122018' },
  serviceDuration: { fontSize: 14, color: '#66736B', marginTop: 4 },
  servicePrice: { fontSize: 16, fontWeight: 'bold', color: '#122018' },
  
  providerGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 24 },
  providerCard: { width: '48%', backgroundColor: '#FFF', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: '#E5EBE7', alignItems: 'center' },
  providerCardSelected: { borderColor: PRIMARY, backgroundColor: '#F0FDF4' },
  providerAvatar: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#EAF8F0', alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  providerName: { fontSize: 15, fontWeight: 'bold', color: '#122018', textAlign: 'center' },
  providerSpecialty: { fontSize: 12, color: '#66736B', marginTop: 4, textAlign: 'center' },
  
  dateChip: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 20, backgroundColor: '#FFF', borderWidth: 1, borderColor: '#E5EBE7', marginRight: 10, minWidth: 80, alignItems: 'center' },
  dateChipSelected: { backgroundColor: PRIMARY, borderColor: PRIMARY },
  dateChipText: { fontSize: 14, fontWeight: '600', color: '#66736B' },
  dateChipTextSelected: { color: '#FFF' },

  slotsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  slotCard: { paddingVertical: 12, paddingHorizontal: 16, backgroundColor: '#FFF', borderRadius: 10, borderWidth: 1, borderColor: '#E5EBE7', alignItems: 'center', minWidth: 90 },
  slotCardFull: { backgroundColor: '#EAF8F0', borderColor: '#E5EBE7', opacity: 0.6 },
  slotText: { fontSize: 14, fontWeight: '600', color: '#122018' },
  slotTextFull: { color: '#8B9690' },
  slotCapacityText: { fontSize: 10, color: '#66736B', marginTop: 4 },
  
  emptyText: { color: '#66736B', textAlign: 'center', paddingVertical: 16 },

  collapsedCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16, backgroundColor: '#F7FAF8', borderRadius: 12, borderWidth: 1, borderColor: '#E5EBE7', marginBottom: 16 },
  collapsedLabel: { fontSize: 12, color: '#66736B', marginBottom: 4 },
  collapsedValue: { fontSize: 16, fontWeight: 'bold', color: '#122018' },
