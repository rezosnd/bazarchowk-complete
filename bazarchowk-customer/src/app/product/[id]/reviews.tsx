      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        {submitted ? (
          <View style={[styles.formBox, { alignItems: 'center' }]}>
            ...
            <Text style={{ color: '#66736B', textAlign: 'center' }}>Thank you for sharing your feedback.</Text>
          </View>
        ) : (
        ...
        {data?.reviews?.length === 0 ? (
          <Text style={{ color: '#66736B', textAlign: 'center', marginTop: 32 }}>No reviews yet.</Text>
        ) : (
