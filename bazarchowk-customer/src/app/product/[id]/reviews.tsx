  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1, backgroundColor: '#FFF' }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        ...
        <AppText style={styles.headerTitle}>Ratings & Reviews</AppText>
        <View style={{ width: 44 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        {submitted ? (
          <View style={[styles.formBox, { alignItems: 'center' }]}>
            ...
            <AppText style={{ color: '#66736B', textAlign: 'center' }}>Thank you for sharing your feedback.</AppText>
          </View>
        ) : (
          <View style={styles.formBox}>
            <AppText style={styles.formTitle}>Write a Review</AppText>
        ...
        {/* Review List */}
        <AppText style={styles.listTitle}>All Reviews</AppText>
        {data?.reviews?.length === 0 ? (
          <AppText style={{ color: '#66736B', textAlign: 'center', marginTop: 32 }}>No reviews yet.</AppText>
        ) : (
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: 16, paddingBottom: 16, borderBottomWidth: 1, borderColor: '#EAF8F0', backgroundColor: '#FFF'
  },
  backBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#F7FAF8', alignItems: 'center', justifyContent: 'center' },
  headerTitle: { fontSize: 18, fontWeight: '800', color: '#122018' },
  scroll: { padding: 20, paddingBottom: 100 },
  summaryBox: { alignItems: 'center', marginBottom: 32 },
  avgRating: { fontSize: 48, fontWeight: '900', color: '#122018' },
  totalReviews: { fontSize: 14, color: '#66736B', fontWeight: '500' },
  
  formBox: { backgroundColor: '#F7FAF8', padding: 20, borderRadius: 20, marginBottom: 32 },
  formTitle: { fontSize: 16, fontWeight: '800', color: '#122018', marginBottom: 16, textAlign: 'center' },
  ...
  input: {
    ...
    borderWidth: 1, borderColor: '#E5EBE7', fontSize: 15, color: '#122018', marginBottom: 16
  },
  submitBtn: { backgroundColor: PRIMARY, padding: 16, borderRadius: 12, alignItems: 'center' },
  submitBtnText: { color: '#FFF', fontSize: 16, fontWeight: '700' },

  listTitle: { fontSize: 18, fontWeight: '800', color: '#122018', marginBottom: 16 },
  reviewCard: { backgroundColor: '#FFF', padding: 16, borderRadius: 16, marginBottom: 16, borderWidth: 1, borderColor: '#E5EBE7' },
  reviewAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#EAF8F0', alignItems: 'center', justifyContent: 'center' },
  reviewAvatarText: { fontSize: 16, fontWeight: '800', color: PRIMARY },
  reviewName: { fontSize: 15, fontWeight: '700', color: '#122018' },
  reviewDate: { fontSize: 12, color: '#8B9690', fontWeight: '500' },
  reviewComment: { fontSize: 15, color: '#66736B', marginTop: 12, lineHeight: 22 },
});
